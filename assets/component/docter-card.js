...
export default function DocterCard({name,type,description,exp,rating,review,img}) {
    ...
    return (
        <>
            <TouchableOpacity style={[styles.mainCon,{width:widthPadding}]} onPress={() => navigation.navigate('docterDesc')}>
            {type == 1 && (
                            <>
...
{type == 3 && (
                ...
                <View style={styles.doctorCon}>
                    ...
                    <TouchableOpacity>
                        <Text style={styles.appointBtn}>Appoint Now</Text>
                    </TouchableOpacity>
                </View>
